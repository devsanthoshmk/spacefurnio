    ...
    <div id="scroll-wrapper" ref="wrapper">
      ...
      >
        ...
        <div class="scroll-section w-full px-6 md:px-12 py-12 mb-8 md:mb-16">
          <div
            class="max-w-[1600px] mx-auto border-t border-b border-gray-300 dark:border-gray-700 py-12 md:py-20 flex flex-col md:flex-row items-start md:items-center justify-between gap-8"
          >
            <div class="max-w-2xl">
              <h2
                class="text-2xl md:text-4xl font-space-serif italic text-space-text-light dark:text-space-text-dark mb-4"
              >
                Discover Our Latest Collection
              </h2>
              <p
                class="text-sm md:text-base text-gray-600 dark:text-gray-400 font-light leading-relaxed max-w-lg"
              >
                Explore a curated selection of minimalist designs that bring harmony and
                functionality to your living spaces.
              </p>
            </div>
            <div class="flex-shrink-0">
              <a
                class="inline-block border border-space-text-light dark:border-space-text-dark px-10 py-4 text-xs tracking-[0.2em] uppercase font-medium hover:bg-space-primary hover:border-space-primary hover:text-white transition-all duration-300"
                href="#"
              >
                Shop Now
              </a>
