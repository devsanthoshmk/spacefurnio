...
<template>
  <div id="scroll-container" class="overflow-clip">
    <div id="scroll-wrapper" ref="wrapper">
      <div
        class="scroll-section bg-background-light text-primary font-body antialiased transition-colors duration-500"
      >
        <!-- Header -->
        <header
          class="relative w-full min-h-screen flex flex-col justify-center items-center overflow-hidden py-20"
        >
          ...
          <div
            class="relative z-10 text-center flex flex-col items-center max-w-5xl px-6 sm:px-8 animate-fadeIn"
          >
            <!-- Logo -->
            <div
              class="-mb-8 md:-mb-10 xl:-mb-10 w-25 sm:w-28 md:w-26 lg:w-34 transition-all duration-700 hover:scale-105"
            >
              <img
            ...
            <!-- Main Title -->
            <h1
              class="font-display mb-0 sm:mb-1 tracking-tight text-gray-900 flex flex-col items-center gap-0"
            >
              <span
                class="phitagate-font bg-clip-text text-8xl xl:text-9xl leading-tight ps-1 text-black font-medium"
              >
                Spacefurnio
              </span>
              ...
              <span
                class="italic text-6xl xl:text-7xl font-light tracking-wide mt-1 md:mt-1 xl:mt-2"
              >
                Collabs
              </span>
            </h1>
            ...
            <!-- Divider -->
            <div
              class="w-16 sm:w-20 md:w-24 h-[2px] bg-gradient-to-r from-transparent via-gray-800 to-transparent my-4 sm:my-5"
            ></div>
          </div>
          ...
          <div class="absolute bottom-6 sm:bottom-10 animate-bounce">
            <span
              class="material-icons text-2xl sm:text-3xl text-gray-500 opacity-60 hover:opacity-100 transition-opacity cursor-pointer"
            >
              keyboard_arrow_down
            </span>
          </div>
        ...
        <div class="py-24 md:py-32 px-6 bg-background-light relative z-10">
          ...
          >
            <p class="font-display text-2xl md:text-4xl leading-relaxed text-gray-800">
              "We believe that true elegance is found in the dialogue between distinct voices. Our
              collaborations series invites the world's most visionary brands to reimagine the
              Spacefurnio aesthetic."
            </p>
          </div>
        </div>
      </div>
