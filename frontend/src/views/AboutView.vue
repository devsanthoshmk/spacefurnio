<template>
  <div id="scroll-container" class="overflow-hidden">
    <div id="scroll-wrapper" ref="wrapper">
      ...
      <section class="scroll-section">
        ...
        <div class="h-[100dvh] md:h-[125dvh] w-full relative">
          ...
          <div class="h-[80%] w-full relative">
            <img src="/images/aboutus/hero/window.png" alt=""
              style="bottom:0; width:100%; height:100%; object-fit:cover; object-position:bottom;" />
            <img src="/images/aboutus/hero/people.png" alt=""
          ...
          <div
            ...
            <p class="text-base md:text-xl text-black font-medium leading-relaxed w-full px-4 drop-shadow-sm mt-[7vh]">
              At <span class="font-bold">Spacefurnio</span>, we are passionate about shaping spaces that reflect
              purpose,
      ...
      <section class="scroll-section relative w-full h-[100dvh] overflow-hidden">
        ...
        <div class="absolute text-center px-5 py-4 rounded-xl" :style="{
          ...
          <h2 class="font-serif leading-tight text-gray-900
    ...
    text-[clamp(0.95rem,2vw,1.4rem)]">
        ...
        <div class="absolute top-[35%] right-1/2 "
          style="transform: translateX(calc(35.41vw)); /* REPLACE -35.41 WITH YOUR MATH */">
          <div
      ...
      <section class="scroll-section what-we-do-section h-[100dvh] md:h-[100dvh] w-full"
        ...
        <div
          ...
          <div class="relative z-10 w-full max-w-6xl xl:max-w-7xl 2xl:max-w-[90rem] mx-auto flex flex-col items-center justify-center h-full">
              ...
              <div
                ...
                <div class="w-full md:w-5/12 lg:w-2/5 flex items-center justify-center md:justify-end">
                  <div class="relative w-full max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl group">
                    ...
                    <img src="https://placehold.co/600x400/e8ddd4/5A4A42?text=Our+Services" alt="What we do - Services"
                ...
                <div class="w-full md:w-5/12 lg:w-2/5 flex flex-col items-center md:items-start">
                  ...
                  <ul class="space-y-2 md:space-y-5 w-full max-w-md">
                    ...
                    <li
                      ...
                      <span class="text-lg sm:text-xl font-medium text-gray-800">Construction &amp; Project
                        Execution</span>
                    </li>
                    <li
                      class="what-we-do-item flex items-center gap-3 p-2 md:p-3 rounded-xl hover:bg-white/60 transition-all duration-300 cursor-default">
                    ...
                    <li
                      ...
                      <span class="text-lg sm:text-xl font-medium text-gray-800">Custom Furniture Design &amp;
                        Manufacturing</span>
                    </li>
                    <li
                      class="what-we-do-item flex items-center gap-3 p-2 md:p-3 rounded-xl hover:bg-white/60 transition-all duration-300 cursor-default">
      ...
      <section id="our-team"
        ...
        <ul class="grid grid-cols-2 md:grid-cols-3  gap-10">
          <li v-for="member in ourteam" :key="member.id" class="flex flex-col items-center text-center">
            <div v-if="member.image && !member.image.includes('placehold.co')"
            ...
            <div v-else
              ...
              <span class="text-4xl md:text-5xl font-bold text-[#5A4A42] font-serif">{{ getInitials(member.name)
                }}</span>
            </div>
            <div class="mt-4">
